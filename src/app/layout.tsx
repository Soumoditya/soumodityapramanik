...
const jsonLd = {
  ...
  name: NAME, url: SITE_URL, jobTitle: 'Full-Stack Developer', description: DESCRIPTION,
  birthDate: '2004-10-12', nationality: 'Indian',
  address: { '@type': 'PostalAddress', addressLocality: 'Rampurhat', addressRegion: 'West Bengal', postalCode: '731224', addressCountry: 'IN' },
  email: 'soumodityapramanik@gmail.com', telephone: '+91-9064882049',
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link href="https://api.fontshare.com/v2/css?f[]=clash-display@700,600,500&f[]=cabinet-grotesk@400,500,700&display=swap" rel="stylesheet" />
